...
import { cn, KPICard, InsightCard } from '@/components/DashboardComponents';
...
export default function DashboardPage() {
    ...
    const generateAiInsights = async () => {
        ...
        if (!envKey) {
            alert("Gemini API Key missing. Please set NEXT_PUBLIC_GEMINI_API_KEY.");
            return;
        }
    ...
    return (
        <div className="min-h-screen p-6 md:p-8 max-w-7xl mx-auto space-y-8 bg-gray-50 text-left">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <div className="relative group">
                        ...
                        <input type="text" placeholder="Search..." className="pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600/20 transition-all text-sm shadow-sm" value={search} onChange={(e) => setSearch(e.target.value)} />
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-1 bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-2xl shadow-lg text-white space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={generateAiInsights} disabled={analyzing} className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-sm transition-colors">{analyzing ? "Analyzing..." : "Generate Strategy"}</button>
                    </div>
                </div>
                <div className="lg:col-span-3">
                    ...
                    ) : <div className="h-full bg-white border border-gray-200 rounded-2xl flex flex-col items-center justify-center p-8 text-gray-400 border-dashed"><Brain size={32} className="mb-2 opacity-20" /><p className="text-sm">Click "Generate Strategy" for AI analysis</p></div>}
                </div>
            </div>
